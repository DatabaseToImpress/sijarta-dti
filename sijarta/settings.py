...
SECRET_KEY = 'django-insecure-r3fyzm%ow&k9^r9xi2y(s8*zdb2*uv$fc=a!w*@!c*e-dhr0v%'
...
MIDDLEWARE = [
    ...
    'sijarta.middlewares.AuthenticationMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'sijarta.context_processors.session_context',
            ],
        },
    },
]
